...
export default function AboutMe() {
  return (
    <div
      className='sticky top-0 flex h-screen w-screen flex-col items-center justify-center bg-transparent'
      id='aboutMe'
    >
      <div className='flex h-screen w-screen flex-col items-center justify-center px-60 py-20'>
        <BrowserWindow title='aboutMe.com'>
          <div className='relative flex h-full w-full flex-row'>
            ...
            <div className='relative w-1/2 p-20'>
              <p
                className='flex h-full w-full flex-col items-center justify-center whitespace-pre-wrap rounded-md  border border-gray-100 bg-gray-900 bg-opacity-10 bg-clip-padding p-10 font-JetbrainsMono
 text-2xl text-white backdrop-blur-md backdrop-filter'
              >
